...
using ECommerce.Ordering.Blazor.Server.Host.Menus;
...
public class OrderingBlazorHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(OrderingResource),
                typeof(OrderingDomainModule).Assembly,
                typeof(OrderingDomainSharedModule).Assembly,
                typeof(OrderingApplicationModule).Assembly,
                typeof(OrderingApplicationContractsModule).Assembly,
                typeof(OrderingBlazorHostModule).Assembly
            );
        });
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/ECommerce.Ordering.Blazor.Server.Host.styles.css");
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<OrderingBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.AppAssembly = typeof(OrderingBlazorHostModule).Assembly;
        });
