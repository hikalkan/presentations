...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c3f6a890-1d0b-47e4-bad3-d7a5865a56bb
```

> `c3f6a890-1d0b-47e4-bad3-d7a5865a56bb` is the password of the certificate, you can change it to any password you want.
